          ...
          {!isSubmitted ? (
            <>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                <div>
                  <label htmlFor="diagnosis-name" className="block text-sm font-medium text-gray-400 mb-2">
                ...
                <div>
                  <label htmlFor="diagnosis-phone" className="block text-sm font-medium text-gray-400 mb-2">
                ...
                <div>
                  <label htmlFor="diagnosis-message" className="block text-sm font-medium text-gray-400 mb-2">
