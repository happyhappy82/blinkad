...
const BlogPage: React.FC<BlogPageProps> = ({ onPostClick, onBack }) => {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
  ...
  return (
    <section className="min-h-screen bg-black pt-28 pb-20">
      <div className="max-w-7xl mx-auto px-6">
        ...
        {/* Newsletter / CTA */}
        <FadeIn delay={400} className="mt-32 p-12 rounded-3xl bg-brand-dark border border-white/5 text-center relative overflow-hidden">
