...
2026-09-26 후속: 홈페이지 제목·연결·문의 문구는 [v3 홈페이지 전환 브리프](NEST_HOMEPAGE_CONVERSION_BRIEFS_20260926.md)가 우선한다. O6는 최종 H2로 통합하고, 장문 예시·양식·반복 FAQ 요구는 이후 사용자 피드백에 따라 적용하지 않는다. 아래 v2는 최초 기획 이력이다.
