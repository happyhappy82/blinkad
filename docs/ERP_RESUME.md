...
- 정산관리에서 에코쟈댕 계약의 광고 집행비와 실제 용역 매출을 분리했습니다.
  - 월 고객 입금액 198만원(VAT 포함) 중 광고 집행비 80만원(VAT 별도)은 순수익 계산에서 제외합니다.
  - 월 용역비 100만원은 애즈 운영 50만원, Google 프로필 관리 50만원으로 구분합니다.
  - 프로필 관리비의 10%인 5만원을 비즈하이 정산금으로 계산합니다.
...
- ERP 계약·운영 현황에 에코쟈댕 2개 지점을 추가하고 도르도뉴를 계약 해제 매장으로 이동했습니다.
  - 에코쟈댕 잠실롯데타워점: 3개월 계약, 운영비 월 100만원 + 광고비 월 80만원, VAT 별도, 2026년 7월 31일 3개월분 입금완료로 등록했습니다.
  - 에코쟈댕 홍대점: 1개월 계약, 운영비 월 100만원 + 광고비 월 80만원, VAT 별도, 2026년 8월 6일 입금완료로 등록했습니다.
  - ERP 매출에는 VAT 포함 월 198만원으로 반영하고, 잠실롯데타워점 총 계약금액은 594만원으로 계산합니다.
  - 도르도뉴의 기존 1개월 매출·입금 이력은 유지하고 현재 운영 분류만 계약 해제로 변경했습니다.
  - 대시보드 `이번달 매출`은 첫 계약월 고정값이 아니라 접속 시점의 실제 정산월을 자동 선택합니다.
  - 청구관리는 계약 개월을 초과해 반복 청구하지 않으며, 잠실롯데타워점 3개월 선입금은 2026년 7월 31일 594만원 1건으로 표시합니다.
