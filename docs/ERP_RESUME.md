...
- 정산관리에서 에코쟈댕 계약의 광고 집행비와 실제 용역 매출을 분리했습니다.
  ...
  - 프로필 관리비의 10%인 5만원은 VAT 포함 비즈하이 실제 정산금입니다. 순수익에서는 공급가 45,455원만 비용으로 차감합니다.
  - 작업자 정산비 15만원에는 3.3% 원천징수를 적용해 원천세 4,950원, 실제 송금액 145,050원으로 표시합니다.
  - 애즈 용역비는 31만원(VAT 별도), 실제 지급액은 341,000원으로 표시합니다.
  - 에코쟈댕의 월 예상 순수익은 `1,000,000 - 45,455 - 150,000 - 310,000 = 494,545원`입니다.
  - 선입금 계약도 정산관리에서는 실제 서비스 월별로 나눠 표시합니다. 2026년 8월 정산에는 렛츠바레, 에코쟈댕 롯데월드몰점, 에코쟈댕 홍대점이 포함됩니다.
